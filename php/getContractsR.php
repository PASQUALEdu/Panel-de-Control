...
// Generar el HTML de las tarjetas de contrato SOLO para contratos regulares (pagados)
foreach ($contracts as $data) {
    ...
    if ($data["nbofservicesopened"] >= 1) {
        ...
        // Determinar estado y clase CSS según los días restantes
        if ($diasRestantes < 0) {
        ...
        // Mostrar solo contratos regulares (los que tienen estado "pagado")
        if ($estadoClass == "pagado") {
