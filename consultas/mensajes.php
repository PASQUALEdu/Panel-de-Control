...
// Archivo para almacenar los mensajes enviados
$archivoLineas = 'mensajes.txt';
    ...
    if (json_last_error() !== JSON_ERROR_NONE) {
        ...
        foreach ($contracts as $data) {
            ...
            if (in_array($data['id'], $lineasProcesadas)) {
                ...
                // Armar el mensaje incluyendo el número de local obtenido de ref_customer
                $mensaje = "Se invita a todos los arrendatarios que aún no cuentan con medidor de luz a realizar su contrato con la CFE para evitar multas y recargos por parte de la Comisión Federal de Electricidad. La plaza no se hará responsable en caso de penalizaciones por la falta de medidor, por lo que cualquier multa deberá ser absorbida por el arrendatario.";
